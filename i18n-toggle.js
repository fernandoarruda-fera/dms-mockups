 ...
 * Mockup conceitual — cobre ~200 chaves em 5 idiomas (1000+ traduções; cobertura ampliada Fix 2026-06-01).
 */
(function () {
  ...
  var DICT = {
    'pt-BR': {
      ...
      // Fix 2026-06-01: cobertura ampliada — mensagens, header, breadcrumb, tabela, tela12
      'msg.loading': 'Carregando...',
      'msg.saving': 'Salvando...',
      'msg.saved': 'Salvo',
      'msg.error': 'Erro',
      'msg.success': 'Sucesso',
      'msg.empty': 'Nenhum resultado',
      'msg.confirmDelete': 'Confirmar exclusão?',
      'msg.unsaved': 'Você tem alterações não salvas',
      'msg.required': 'Campo obrigatório',
      'msg.networkError': 'Erro de conexão',
      'msg.tryAgain': 'Tentar novamente',
      'msg.copySuccess': 'Copiado para área de transferência',
      ...
      'breadcrumb.youAreHere': 'Você está em',
      'filter.basic': 'Filtros básicos',
      'filter.byTag': 'Filtrar por TAG',
      'filter.byTagWhich': 'Qual dado dessa TAG?',
      ...
      'table.of': 'de',
      'table.noData': 'Sem dados para mostrar',
      'tela12.title': 'Visibilidade de Execução',
      'tela12.runningNow': 'Rodando agora',
      'tela12.onTime': 'On Time',
      'tela12.warning': 'Warning',
      'tela12.delay': 'Atrasado',
      'tela12.blocked': 'Bloqueado',
      'tela12.customizeView': 'Personalizar visualização',
      'tela12.aiGenerate': 'Gerar via IA',
      'tela12.saveView': 'Salvar visualização',
      'tela12.aiHint': '⚙️ IA real chega em F3 (Copilot). Aqui é mock visual.',
      // toast
    ...
    'en': {
      ...
      'msg.confirmDelete': 'Confirm deletion?',
      ...
      'breadcrumb.youAreHere': 'You are in',
      'filter.basic': 'Basic filters',
      'filter.byTag': 'Filter by TAG',
      'filter.byTagWhich': 'Which TAG data?',
      'filter.add': 'Add filter',
      'filter.clear': 'Clear filters',
      'action.viewDetails': 'View details',
      'action.duplicate': 'Duplicate',
      'action.exportCsv': 'Export CSV',
      'action.exportXlsx': 'Export Excel',
      'action.print': 'Print',
      'action.share': 'Share',
      'table.rowsPerPage': 'Rows per page',
      'table.of': 'of',
      'table.noData': 'No data to display',
      'tela12.title': 'Execution Visibility',
      'tela12.runningNow': 'Running now',
      'tela12.onTime': 'On Time',
      'tela12.warning': 'Warning',
      'tela12.delay': 'Delayed',
      'tela12.blocked': 'Blocked',
      'tela12.customizeView': 'Customize view',
      'tela12.aiGenerate': 'Generate via AI',
      'tela12.saveView': 'Save view',
      'tela12.aiHint': '⚙️ Full AI arrives in F3 (Copilot). Visual mock here.',
    ...
    'es': {
      ...
      'msg.error': 'Error',
      'msg.success': 'Éxito',
      'msg.empty': 'Sin resultados',
      'msg.confirmDelete': '¿Confirmar eliminación?',
      'msg.unsaved': 'Tiene cambios sin guardar',
      'msg.required': 'Campo obligatorio',
      'msg.networkError': 'Error de conexión',
      'msg.tryAgain': 'Reintentar',
      'msg.copySuccess': 'Copiado al portapapeles',
      ...
      'breadcrumb.youAreHere': 'Está en',
      'filter.basic': 'Filtros básicos',
      'filter.byTag': 'Filtrar por TAG',
      'filter.byTagWhich': '¿Qué dato de la TAG?',
      ...
      'table.of': 'de',
      'table.noData': 'Sin datos para mostrar',
      'tela12.title': 'Visibilidad de Ejecución',
      'tela12.runningNow': 'Ejecutándose ahora',
      'tela12.onTime': 'En plazo',
      'tela12.warning': 'Aviso',
      'tela12.delay': 'Retrasado',
      'tela12.blocked': 'Bloqueado',
      'tela12.customizeView': 'Personalizar vista',
      'tela12.aiGenerate': 'Generar con IA',
      'tela12.saveView': 'Guardar vista',
      'tela12.aiHint': '⚙️ IA completa llega en F3 (Copilot). Aquí es mock visual.',
    ...
    'pt-PT': {
      ...
      'msg.error': 'Erro',
      'msg.success': 'Sucesso',
      'msg.empty': 'Sem resultados',
      'msg.confirmDelete': 'Confirmar eliminação?',
      'msg.unsaved': 'Tem alterações por guardar',
      'msg.required': 'Campo obrigatório',
      'msg.networkError': 'Erro de ligação',
      'msg.tryAgain': 'Tentar de novo',
      'msg.copySuccess': 'Copiado para área de transferência',
      'header.notifications': 'Notificações',
      'header.profile': 'Perfil',
      'header.logout': 'Sair',
      ...
      'sidebar.expand': 'Expandir menu',
      'breadcrumb.home': 'Início',
      'breadcrumb.youAreHere': 'Está em',
      'filter.basic': 'Filtros básicos',
      'filter.byTag': 'Filtrar por TAG',
      'filter.byTagWhich': 'Que dado dessa TAG?',
      'filter.add': 'Adicionar filtro',
      'filter.clear': 'Limpar filtros',
      'action.viewDetails': 'Ver detalhes',
      'action.duplicate': 'Duplicar',
      ...
      'table.noData': 'Sem dados para mostrar',
      'tela12.title': 'Visibilidade de Execução',
      'tela12.runningNow': 'A correr agora',
      'tela12.onTime': 'No prazo',
      'tela12.warning': 'Aviso',
      'tela12.delay': 'Atrasado',
      'tela12.blocked': 'Bloqueado',
      'tela12.customizeView': 'Personalizar visualização',
      'tela12.aiGenerate': 'Gerar com IA',
      'tela12.saveView': 'Guardar visualização',
      'tela12.aiHint': '⚙️ IA completa chega na F3 (Copilot). Aqui é mock visual.',
      'toast.langChanged': 'Idioma alterado para',
    },
    'de': {
      'nav.cockpit': 'Cockpit',
      ...
      'msg.error': 'Fehler',
      'msg.success': 'Erfolg',
      'msg.empty': 'Keine Ergebnisse',
      'msg.confirmDelete': 'Löschung bestätigen?',
      'msg.unsaved': 'Sie haben ungespeicherte Änderungen',
      'msg.required': 'Pflichtfeld',
      'msg.networkError': 'Verbindungsfehler',
      'msg.tryAgain': 'Erneut versuchen',
      'msg.copySuccess': 'In Zwischenablage kopiert',
      ...
      'sidebar.expand': 'Menü ausklappen',
      'breadcrumb.home': 'Start',
      'breadcrumb.youAreHere': 'Sie sind in',
      'filter.basic': 'Grundfilter',
      'filter.byTag': 'Nach TAG filtern',
      'filter.byTagWhich': 'Welches TAG-Datum?',
      ...
      'action.exportXlsx': 'Excel exportieren',
      'action.print': 'Drucken',
      'action.share': 'Teilen',
      'table.rowsPerPage': 'Zeilen pro Seite',
      'table.of': 'von',
      'table.noData': 'Keine Daten anzuzeigen',
      'tela12.title': 'Ausführungssichtbarkeit',
      'tela12.runningNow': 'Läuft jetzt',
      'tela12.onTime': 'Pünktlich',
      'tela12.warning': 'Warnung',
      'tela12.delay': 'Verzögert',
      'tela12.blocked': 'Blockiert',
      'tela12.customizeView': 'Ansicht anpassen',
      'tela12.aiGenerate': 'Mit KI generieren',
      'tela12.saveView': 'Ansicht speichern',
      'tela12.aiHint': '⚙️ Echte KI kommt in F3 (Copilot). Hier ist Visual-Mock.',
